    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(help_text='An implementation statement that describes how a control or a control statement is implemented within the referenced system component.', verbose_name='Control Implementation Description')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('remarks', models.TextField(blank=True, default='', help_text='Additional commentary on the containing object.', verbose_name='Remarks')),
                ('description', models.TextField(help_text='An implementation statement that describes the aspects of a control or control statement implementation that a leveraging system is inheriting from a leveraged system.', verbose_name='Control Implementation Responsibility Description')),
                ('links', common.models.CustomManyToManyField(to='common.links', verbose_name='Links')),
                ('props', common.models.propertiesField(to='common.props')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statements', common.models.CustomManyToManyField(help_text='Identifies which statements within a control are addressed.', to='component.statements', verbose_name='Specific Control Statement')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('remarks', models.TextField(blank=True, default='', help_text='Additional commentary on the containing object.', verbose_name='Remarks')),
                ('description', models.TextField(help_text='An implementation statement that describes the aspects of the control or control statement implementation that can be available to another system leveraging this system.', verbose_name='Control Implementation Export Description')),
                ('links', common.models.CustomManyToManyField(to='common.links', verbose_name='Links')),
                ('props', common.models.propertiesField(to='common.props')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('remarks', models.TextField(blank=True, default='', help_text='Additional commentary on the containing object.', verbose_name='Remarks')),
                ('description', models.TextField(help_text='Describes how the system satisfies a set of controls.', verbose_name='Description')),
                ('implemented_requirements', common.models.CustomManyToManyField(help_text='Describes how the system satisfies controls.', to='component.implemented_requirements', verbose_name='Implemented Requirements')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(help_text='A description of the component, including information about its function.', verbose_name='Component Description')),
                ...
                ('control_implementations', common.models.CustomManyToManyField(help_text='Defines how the component supports a set of controls.', to='component.control_implementations', verbose_name='Control Implementation Set')),
                ('links', common.models.CustomManyToManyField(to='common.links', verbose_name='Links')),
                ('props', common.models.propertiesField(to='common.props')),
        ...
        migrations.AddField(
            ...
            name='component_uuid',
            field=models.ForeignKey(help_text='A reference to the component that is implementing a given control or control statement.', on_delete=django.db.models.deletion.CASCADE, to='component.components', verbose_name='Component Universally Unique Identifier Reference'),
        ),
        migrations.AddField(
            model_name='by_components',
            name='export',
            field=models.ForeignKey(help_text='Identifies content intended for external consumption, such as with leveraged organizations.', null=True, on_delete=django.db.models.deletion.CASCADE, to='component.export', verbose_name='Export'),
        ),
        migrations.AddField(
            model_name='by_components',
            name='inherited',
            field=common.models.CustomManyToManyField(help_text='Describes a control implementation inherited by a leveraging system.', to='component.inherited', verbose_name='Inherited Control Implementation'),
        ),
        migrations.AddField(
            model_name='by_components',
            name='links',
        ...
        migrations.AddField(
            model_name='by_components',
            name='satisfied',
            field=common.models.CustomManyToManyField(help_text='Describes how this system satisfies a responsibility imposed by a leveraged system.', to='component.satisfied', verbose_name='Satisfied Control Implementation Responsibility'),
        ),
        migrations.AddField(
            model_name='by_components',
            name='set_parameters',
            field=common.models.CustomManyToManyField(help_text='Identifies the parameter that will be set by the enclosed value. Overrides globally set parameters of the same name', to='component.parameters', verbose_name='Set Parameter Value'),
        ),
    ]
