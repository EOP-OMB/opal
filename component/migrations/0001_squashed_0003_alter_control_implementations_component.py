# Generated by Django 4.0.6 on 2022-07-25 19:31
...
class Migration(migrations.Migration):
    ...
    replaces = [('component', '0001_initial'), ('component', '0002_remove_components_control_implementations_and_more'), ('component', '0003_alter_control_implementations_component')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('set_parameters', common.models.CustomManyToManyField(help_text='Identifies the parameter that will be set by the enclosed value. Overrides globally set parameters of the same name', to='component.parameters', verbose_name='Set Parameter Value')),
                ('implemented_requirement', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='component.implemented_requirements')),
            ],
            options={
