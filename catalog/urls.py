...
from catalog.views import catalog_index_view, catalog_list_view, catalog_detail_view, import_catalog_view,control_detail_view,load_controls,load_statements
