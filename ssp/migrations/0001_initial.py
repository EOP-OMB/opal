# Generated by Django 3.1 on 2020-08-05 01:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('properties', ssp.models.customMany2ManyField(blank=True, to='ssp.element_property')),
                ('system_status', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='ssp.status')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adjusted_confidentiality_impact', models.CharField(blank=True, choices=[(1, 'High'), (2, 'Moderate'), (3, 'Low')], max_length=50)),
                ('adjusted_integrity_impact', models.CharField(blank=True, choices=[(1, 'High'), (2, 'Moderate'), (3, 'Low')], max_length=50)),
                ('adjusted_availability_impact', models.CharField(blank=True, choices=[(1, 'High'), (2, 'Moderate'), (3, 'Low')], max_length=50)),
                ('adjustment_justification', ssp.models.customTextField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('properties', ssp.models.customMany2ManyField(blank=True, to='ssp.element_property')),
                ('telephone_numbers', ssp.models.customMany2ManyField(blank=True, to='ssp.telephone_number')),
            ],
        ),
        migrations.AddField(
