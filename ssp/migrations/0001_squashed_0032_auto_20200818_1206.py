# Generated by Django 3.0.7 on 2020-08-18 17:26
...
# ssp.migrations.0031_auto_20200818_1206

class Migration(migrations.Migration):

    replaces = [('ssp', '0001_initial'), ('ssp', '0002_auto_20200817_1124'), ('ssp', '0003_auto_20200817_1140'), ('ssp', '0004_auto_20200817_1159'), ('ssp', '0005_auto_20200817_1202'), ('ssp', '0006_auto_20200817_1213'), ('ssp', '0007_delete_sspbasicmodel'), ('ssp', '0008_auto_20200817_1221'), ('ssp', '0009_auto_20200817_1545'), ('ssp', '0010_auto_20200817_1546'), ('ssp', '0011_auto_20200817_1548'), ('ssp', '0012_auto_20200817_1550'), ('ssp', '0013_auto_20200817_1551'), ('ssp', '0014_auto_20200817_1553'), ('ssp', '0015_auto_20200817_1555'), ('ssp', '0016_auto_20200817_1609'), ('ssp', '0017_remove_system_component_remarks'), ('ssp', '0018_auto_20200817_1612'), ('ssp', '0019_auto_20200817_1625'), ('ssp', '0020_auto_20200817_1626'), ('ssp', '0021_auto_20200817_1631'), ('ssp', '0022_auto_20200817_1634'), ('ssp', '0023_auto_20200817_1651'), ('ssp', '0024_auto_20200817_1658'), ('ssp', '0025_auto_20200817_1738'), ('ssp', '0026_auto_20200817_1751'), ('ssp', '0027_auto_20200817_1753'), ('ssp', '0028_auto_20200817_1756'), ('ssp', '0029_auto_20200818_1030'), ('ssp', '0030_auto_20200818_1200'), ('ssp', '0031_auto_20200818_1206'), ('ssp', '0032_auto_20200818_1206')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', ssp.models.customTextField(help_text='A short textual description', verbose_name='description')),
                ('remarks', ssp.models.customTextField(help_text='general notes or comments')),
        ...
        migrations.AddField(
            ...
            name='link_to_SSP',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='link_to_ssp', to='ssp.link'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remarks', ssp.models.customTextField(help_text='general notes or comments')),
                ('annotations', ssp.models.customMany2ManyField(blank=True, to='ssp.annotation')),
                ('control_statement_responsible_roles', ssp.models.customMany2ManyField(blank=True, to='ssp.user_role')),
                ('links', ssp.models.customMany2ManyField(blank=True, to='ssp.link')),
                ('properties', ssp.models.customMany2ManyField(blank=True, to='ssp.element_property')),
                ('desc', ssp.models.customTextField(help_text='A short textual description', verbose_name='description')),
                ('short_name', models.CharField(blank=True, help_text='A common name, short name, or acronym', max_length=255)),
        ...
        migrations.AddField(
            model_name='leveraged_authorization',
            name='annotations',
            field=ssp.models.customMany2ManyField(blank=True, to='ssp.annotation'),
        ),
        migrations.AddField(
            model_name='leveraged_authorization',
            name='links',
        ...
        migrations.RemoveField(
            model_name='system_interconnection',
            name='system_interconnection_id',
        ),
        migrations.AddField(
            model_name='inventory_item_type',
            name='desc',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('control_responsible_roles', ssp.models.customMany2ManyField(blank=True, to='ssp.user_role')),
                ('control_statements', ssp.models.customMany2ManyField(blank=True, to='ssp.control_statement')),
                ('links', ssp.models.customMany2ManyField(blank=True, to='ssp.link')),
                ('nist_control', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='ssp.nist_control')),
                ('properties', ssp.models.customMany2ManyField(blank=True, to='ssp.element_property')),
                ('desc', ssp.models.customTextField(help_text='A short textual description', verbose_name='description')),
        ...
        migrations.AddField(
            ...
            name='control_implementation',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='ssp.control_implementation'),
        ),
        migrations.AddField(
            model_name='system_control',
            name='desc',
