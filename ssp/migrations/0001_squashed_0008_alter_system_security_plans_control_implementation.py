    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', ckeditor.fields.RichTextField(blank=True, help_text='A summary of the diagram. This description is intended to be used as alternate text to support compliance with requirements from Section 508 of the United States Workforce Rehabilitation Act of 1973.', verbose_name='Diagram Description')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('remarks', ckeditor.fields.RichTextField(blank=True, default='', help_text='Additional commentary on the containing object.', verbose_name='Remarks')),
                ('href', common.models.ShortTextField(blank=True, help_text="A resolvable URL reference to the profiles to use as the system's control baseline.", verbose_name='Profile Reference')),
                ('local_profile', models.ForeignKey(help_text="A local profile to use as the system's control baseline.", null=True, on_delete=django.db.models.deletion.CASCADE, to='ctrl_profile.profiles', verbose_name='Profile Reference')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adjustment_justification', ckeditor.fields.RichTextField(help_text='If the selected security level is different from the base security level, this contains the justification for the change.', null=True, verbose_name='Adjustment Justification')),
                ('links', common.models.CustomManyToManyField(to='common.links', verbose_name='Links')),
                ('props', common.models.properties_field(to='common.props')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('remarks', ckeditor.fields.RichTextField(blank=True, default='', help_text='Additional commentary on the containing object.', verbose_name='Remarks')),
                ('description', ckeditor.fields.RichTextField(help_text='A summary of the inventory item stating its purpose within the system.', verbose_name='Inventory Item Description')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('remarks', ckeditor.fields.RichTextField(blank=True, default='', help_text='Additional commentary on the containing object.', verbose_name='Remarks')),
                ('description', ckeditor.fields.RichTextField(help_text="A summary of the system's Network Architecture.", verbose_name='Network Architecture Description')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', ckeditor.fields.RichTextField(help_text=" A summary of the user's purpose within the system.", verbose_name='User Description')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('remarks', ckeditor.fields.RichTextField(blank=True, default='', help_text='Additional commentary on the containing object.', verbose_name='Remarks')),
                ('description', ckeditor.fields.RichTextField(help_text="A summary of the system's authorization boundary.", verbose_name='Authorization Boundary Description')),
                ('diagrams', common.models.CustomManyToManyField(help_text='A graphic that provides a visual representation the Authorization Boundary, or some aspect of it.', to='ssp.diagrams', verbose_name='Diagram(s)')),
                ('links', common.models.CustomManyToManyField(to='common.links', verbose_name='Links')),
                ('props', common.models.properties_field(to='common.props')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('remarks', ckeditor.fields.RichTextField(blank=True, default='', help_text='Additional commentary on the containing object.', verbose_name='Remarks')),
                ('description', ckeditor.fields.RichTextField(help_text="A summary of the system's Data Flow.", verbose_name='Data Flow Description')),
                ('diagrams', common.models.CustomManyToManyField(help_text='A graphic that provides a visual representation the Data Flow, or some aspect of it.', to='ssp.diagrams', verbose_name='Diagram(s)')),
                ('links', common.models.CustomManyToManyField(to='common.links', verbose_name='Links')),
                ('props', common.models.properties_field(to='common.props')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', ckeditor.fields.RichTextField(help_text='A summary of the system.', null=True, verbose_name='System Description')),
                ...
                ('security_sensitivity_level', common.models.ShortTextField(choices=[('HIGH', 'HIGH'), ('MODERATE', 'MODERATE'), ('LOW', 'LOW')], help_text='The overall information system sensitivity categorization, such as defined by FIPS-199.', null=True, verbose_name='Security Sensitivity Level')),
                ('security_impact_level', common.models.ShortTextField(choices=[('HIGH', 'HIGH'), ('MODERATE', 'MODERATE'), ('LOW', 'LOW')], help_text='The overall level of expected impact resulting from unauthorized disclosure, modification, or loss of access to information.', null=True, verbose_name='Security Impact Level')),
                ('security_objective_confidentiality', common.models.ShortTextField(choices=[('HIGH', 'HIGH'), ('MODERATE', 'MODERATE'), ('LOW', 'LOW')], help_text='A target-level of confidentiality for the system, based on the sensitivity of information within the system.', null=True, verbose_name='Security Objective: Confidentiality')),
                ('security_objective_integrity', common.models.ShortTextField(choices=[('HIGH', 'HIGH'), ('MODERATE', 'MODERATE'), ('LOW', 'LOW')], help_text='A target-level of integrity for the system, based on the sensitivity of information within the system.', null=True, verbose_name='Security Objective: Integrity')),
                ('security_objective_availability', common.models.ShortTextField(choices=[('HIGH', 'HIGH'), ('MODERATE', 'MODERATE'), ('LOW', 'LOW')], help_text='A target-level of availability for the system, based on the sensitivity of information within the system.', null=True, verbose_name='Security Objective: Availability')),
                ...
                ('props', common.models.properties_field(to='common.props')),
                ('responsible_parties', common.models.CustomManyToManyField(help_text='A reference to a set of organizations or persons that have responsibility for performing a referenced role in the context of the containing object.', to='common.responsible_parties', verbose_name='Responsible Parties')),
                ('system_ids', common.models.CustomManyToManyField(help_text='One or more unique identifier(s) for the system described by this system security plan.', to='ssp.system_ids', verbose_name='Alternative System Identifier')),
                ('system_information', common.models.CustomManyToManyField(help_text='Contains details about all information types that are stored, processed, or transmitted by the system, such as privacy information, and those defined in NIST SP 800-60.', to='ssp.systems_information', verbose_name='System Information')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('links', common.models.CustomManyToManyField(to='common.links', verbose_name='Links')),
                ('props', common.models.properties_field(to='common.props')),
                ('users', common.models.CustomManyToManyField(help_text='A type of user that interacts with the system based on an associated role.', to='ssp.users', verbose_name='System Users')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('control_implementation', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='component.control_implementations')),
