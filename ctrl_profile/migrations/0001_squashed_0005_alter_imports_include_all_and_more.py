...
class Migration(migrations.Migration):
    ...
    replaces = [('ctrl_profile', '0001_squashed_0004_remove_imports_tn_ancestors_count_and_more'), ('ctrl_profile', '0005_alter_imports_include_all_and_more')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('include_all', models.BooleanField(default=True, help_text='Choose this option to include all controls from the imported catalog or profiles', verbose_name='Include all controls')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('set_parameters', common.models.CustomManyToManyField(help_text='Select any parameters you wish to modify', to='catalog.params', verbose_name='Modified Parameters')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modify', models.ForeignKey(help_text='Define parameters and controls that are modified by this profiles.', null=True, on_delete=django.db.models.deletion.CASCADE, to='ctrl_profile.modify', verbose_name='Modifications')),
            ],
            options={
