...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='imports',
            name='tn_parent',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tn_children', to='ctrl_profile.imports', verbose_name='Parent'),
        ),
        migrations.AddField(
            model_name='imports',
            name='tn_priority',
        ...
        migrations.AddField(
            model_name='modify',
            name='tn_parent',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tn_children', to='ctrl_profile.modify', verbose_name='Parent'),
        ),
        migrations.AddField(
            model_name='modify',
            name='tn_priority',
        ...
        migrations.AddField(
            model_name='profiles',
            name='tn_parent',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tn_children', to='ctrl_profile.profiles', verbose_name='Parent'),
        ),
        migrations.AddField(
            model_name='profiles',
            name='tn_priority',
