    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rel', common.models.ShortTextField(blank=True, help_text="Describes the type of relationship provided by the link. This can be an indicator of the link's purpose.", verbose_name='Relation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ns', common.models.ShortTextField(help_text="A namespace qualifying the property's name. This allows different organizations to associate distinct semantics with the same name.", verbose_name='Property Namespace')),
